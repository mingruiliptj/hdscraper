...
# 2. In Colab, run: %run Human_Image_Scraper_Colab_Fixed.py

# Human Image Scraper for Google Colab
# With CPU-only face detection (avoids CUDA errors)
"""

def setup_environment():
    """Run this function to set up the environment in Google Colab"""
    import os
    import sys
    ...
    print("Setting up environment for face detection in Colab...")
    ...
    # We'll use a different approach for face detection that doesn't require dlib
    # This avoids the installation freeze issue
    ...
    print("✅ Setup complete - Using MediaPipe for face detection (more reliable than dlib in Colab)")
    return True

def run_scraper():
    """Main script to scrape and process images"""
    import os
    import requests
    ...
    print("=" * 80)
    print("Human Image Scraper for LoRA Training (MediaPipe Face Detection)")
...
if __name__ == "__main__":
    # Ask user what to do
    print("Human Image Scraper for Google Colab")
